...
import { MenuOutlined, CalculatorOutlined, UserOutlined, QuestionCircleOutlined, InfoCircleOutlined } from '@ant-design/icons';
...
const AppHeader = () => {
  ...
  return (
    <Header style={{ backgroundColor: 'white' }} className="backdrop-blur-md shadow-sm flex items-center justify-between px-4 sm:px-6 md:px-8 h-16 sticky top-0 z-10">
      <motion.div 
      ...
      >
        ...
        <Title level={4} className="!m-0 hidden sm:block gradient-text">退休金计算器</Title>
      </motion.div>
      ...
      >
        <Menu 
          ...
          items={menuItems.map(item => ({
            key: item.key,
            label: (
              <motion.span variants={menuItemVariants} className="flex items-center">
